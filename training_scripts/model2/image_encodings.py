...
##
##      error_file = open('/scratch/vvt223/data_processed/error.file.txt','wb')
##      
...
##        count_samples = 0
##
##        for files in os.listdir(s_path+'/video'):
##
...
##          mouth_video = read_video(os.path.join(s_path+'/video',fname+'.mpg'))
##        
##          word_count = 0
##          first_occurence = False
##          sentence = ['start']
...
if __name__ == '__main__':
    ...
    encod = Encodings()
    with open('/scratch/vvt223/data/X_train_10000.txt','r') as f:
        data_train = f.readlines()
    f.close()

    with open('/scratch/vvt223/data/X_val_3000.txt','r') as f:
        data_val = f.readlines()
    f.close()
    with open('/scratch/vvt223/data/X_test_2000.txt','r') as f:
        data_test = f.readlines()
    f.close()

    print('------------Train Routine Started-------------------')
    encod.generateEncodingSamples(data_train[0:8000],'train')
    print('------------Validation Routine Started-------------------')
    encod.generateEncodingSamples(data_val[0:2000],'train')
    print('------------Test Routine Started-------------------')
    encod.generateEncodingSamples(data_test[0:1500],'test')
    #encod.generateEncodings('/scratch/vvt223/data/seen_speakers/',mode='train')
    #encod.generateEncodings('/scratch/vvt223/data/unseen_speakers/',mode='test')
